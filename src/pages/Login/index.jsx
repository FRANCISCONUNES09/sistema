       ...
       <div className="w-full h-screen flex">
        <div className="w-[40%] h-full flex items-center justify-center ">
            <div className="w-[60%] h-[40%] p-[45px] flex justify-center flex-col">
                ...
                <input type="usuario" id="user"className="w-full rounded-md p-[10px] text-black m-2 bg-gray-200" placeholder="user"/>
                ...
                <input type="password" id="pass" className="w-full rounded-md p-[10px] text-black m-2 bg-gray-200" placeholder="Password"  />
                    ...
                    <p className="w-full text-[15px] text-black p-2">Esqueci minha senha</p> 
